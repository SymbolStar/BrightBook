...
public class ZhihuDailyNewsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<ZhihuDailyNews.Story> list = new ArrayList<ZhihuDailyNews.Story>();
    private OnRecyclerViewOnClickListener mListener;

    private static final int TYPE_NORMAL = 0;
    private static final int TYPE_FOOTER = 1;

    public ZhihuDailyNewsAdapter(Context context, List<ZhihuDailyNews.Story> list){
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof NormalViewHolder) {
            ...
            ZhihuDailyNews.Story item = list.get(position);
