...
import com.scottfu.brightbook.adapter.DoubanAdapter;
...
public class DoubanFragment extends Fragment
        implements DoubanContract.View {
    ...
    @Override
    public void showResults(ArrayList<DoubanNews.posts> list) {
        if (adapter == null) {
            adapter = new DoubanAdapter(getContext(), list);
